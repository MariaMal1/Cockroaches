...
public class PlantsDB {
    ...
    public static final double[][] plantsFixedData = {
            ...
            // (hours/unit)
            { 33, 15000 , 24.5, 105, 0.8  }, // Apples: 80 λίτρα ανά δέντρο
            { 30, 14000, 21.5, 63, 1.5 }, // Oranges: 100 λίτρα ανά δέντρο
            { 30, 16000, 24.5, 72, 1.1 }, // Peaches: 70 λίτρα ανά δέντρο
            { 20, 12000, 19.5, 105, 0.7 }, // Pears: 75 λίτρα ανά δέντρο
            { 6, 6000, 12, 40 , 0.125 }, // Grapes: 50 λίτρα ανά δέντρο
            { 30, 18000, 28.5, 120 , 1.3 }, // Kiwis: 120 λίτρα ανά δέντρο
            { 36, 10000, 16.5, 60, 0.9}, // Olives: 60 λίτρα ανά δέντρο
            { 30, 12000, 19.5, 110, 0.9 }, // Figs: 40 λίτρα ανά δέντρο
            { 30, 14000, 19.5, 80, 0.9 }, // Pomegranates: 85 λίτρα ανά δέντρο
